...
user_info = user_info.rename(columns=lambda x: x.strip()) #removes whitespaces from headers if exists

user_info['age'] = pd.to_datetime('today').year-pd.to_datetime(user_info['dob']).dt.year
...
combined_final = combined_final.rename(columns={'price': 'price_sum',
...
# Go through all Countries and add locations to 'coordinates' dictionary
...
print ("Categorical classes:", PT_label_encoder.classes_)

PT_integer_classes = PT_label_encoder.transform(PT_label_encoder.classes_)

print ("Integer classes:", PT_integer_classes)
...
print ("Categorical classes:", CO_label_encoder.classes_)

CO_integer_classes = CO_label_encoder.transform(CO_label_encoder.classes_)

print ("Integer classes:", CO_integer_classes)
...
############## CLass Variable Pie Chart Before Dataset Balancing #############
...
############## CLass Variable Pie Chart After Dataset Balancing ##############
